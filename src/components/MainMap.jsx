...
import { region1, region2, region3, region4 } from '../RegionIcons/AllRegions';
...
import { RegionList, RegionItem } from './MainMap.styled';

export const MainMap = () => {
  const { selectedCity } = useParams();

  const handleHover = (event) => {
    event.target.style.filter = 'drop-shadow(0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19))';
  };
...
//           <RegionItem
//             key={city[0]}
//             className={classNames(`${city[0]}`, {
//               'is-active': city[0] === selectedCity,
//             })}
//           >
//             <Link
//               to={`../${city[0]}`}
